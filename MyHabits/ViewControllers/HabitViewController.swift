...
class HabitViewController: UIViewController {
    ...
    private func setupView() {
        ...
        [nameLabel, colorLabel, timeLabelTitle, habitNameTextField, habitColorImageView, timeLabel, datePicker, habitDeleteButton].forEach { view.addSubview($0) }
...
//    }
    ...
    @objc func habitDeleteButtonTap() {
        ...
        let alert = UIAlertController(
            ...
            message: "Вы хотите удалить привычку \"\(HabitsStore.shared.habits[index].name)\"?",
